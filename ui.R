...
shinyUI(fluidPage(title="ACPred: A computational tool for the prediction and analysis of anticancer peptides", theme=shinytheme("cerulean"),
                  useShinyjs(),
                  navbarPage(strong("ACPred"), collapsible = TRUE,
                             titleContent <- HTML("<b>ACPred</b>: A computational tool for the prediction and analysis of anticancer peptides"),
